...
insert into book(title, author_no) values('아리랑', 3);
insert into book(title, author_no) values('태백산맥', 3);
insert into book(title, author_no) values('젊은그들', 4);
insert into book(title, author_no) values('아프니깐 청춘이다', 5);
insert into book(title, author_no) values('귀천', 6);
insert into book(title, author_no) values('풀하우스', 7);
